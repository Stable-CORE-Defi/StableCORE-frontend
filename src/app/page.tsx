        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="col-span-1 md:col-span-2">
              <h3 className="text-2xl font-bold text-black mb-4">StableCORE</h3>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-black hover:text-gray-800 transition-colors">Documentation</a></li>

                <li><a href="#" className="text-black hover:text-gray-800 transition-colors">Security</a></li>
                <li><a href="#" className="text-black hover:text-gray-800 transition-colors">Audit Reports</a></li>
          ...
          <div className="border-t border-black border-opacity-20 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex space-x-6 text-sm">
                <a href="#" className="text-black hover:text-gray-800 transition-colors font-medium">Privacy Policy</a>
                <a href="#" className="text-black hover:text-gray-800 transition-colors font-medium">Terms of Service</a>
                <a href="#" className="text-black hover:text-gray-800 transition-colors font-medium">Cookie Policy</a>
                <a href="#" className="text-black hover:text-gray-800 transition-colors font-medium">Support</a>
              </div>
            </div>
          </div>
        </div>
